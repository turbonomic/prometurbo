...
func (k *k8sTopologyHelper) handleNvidiaGPU(entity *data.DIFEntity) {
	...
	metricsWithGpuRequest := make(map[string][]*data.DIFMetricVal)
...
func (k *k8sTopologyHelper) handleKepler(entity *data.DIFEntity) {
	...
	containerEntity := k.getOrBuildEntity("container", containerName, containerId, containerId, entity.Metrics, map[string][]*data.DIFMetricVal{})
