...
find ./ -type f -name '*.y*' -exec sed -i.bak -e "s|<PROMETURBO_IMAGE_TAG>|${VERSION}|g; s|<PROMETURBO_OPERATOR_IMAGE_TAG>|${VERSION}|g; s|<TURBODIF_IMAGE_TAG>|${VERSION}|g; s|<TURBONOMIC_SERVER_VERSION>|${VERSION}|g" {} +
