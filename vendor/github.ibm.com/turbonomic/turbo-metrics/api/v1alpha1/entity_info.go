...
type EntityConfiguration struct {
	...
	// This field is required and must be one of application, databaseServer, virtualMachine,
	// or nvidiaGPU.
	// +kubebuilder:validation:Enum=application;databaseServer;virtualMachine;nvidiaGPU;kepler
...
type AttributeConfiguration struct {
	...
	// delimeter to use when combing values from multiple labels
