...
type MetricConfiguration struct {
	...
	// +kubebuilder:validation:Enum=responseTime;transaction;heap;collectionTime;cacheHitRate;dbMem;cpu;memory;gpu;gpuMem;queuingTime;serviceTime;concurrentQueries;energy
